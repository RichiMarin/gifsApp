export interface SearchGifsResponde {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsResponde(json: string): SearchGifsResponde {
        return cast(JSON.parse(json), r("SearchGifsResponde"));
    }

    public static searchGifsRespondeToJson(value: SearchGifsResponde): string {
        return JSON.stringify(uncast(value, r("SearchGifsResponde")), null, 2);
    }
}
